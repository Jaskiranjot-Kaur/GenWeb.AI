...
function LoginModel({ open, onClose }) {
  ...
  const handleGoogleAuth = async ()=>{
    try {
      ...
      },{withCredentials: true}) //ye withCredentials isliye taki cookie client pe save ho jaye
                  ...
                  <motion.div
                    ...
                    <div className="relative px-8 pt-14 pb-10 text-center">
                      ...
                      <motion.button
                        ...
                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/Google_%22G%22_logo.svg/500px-Google_%22G%22_logo.svg.png" alt="" className='h-5 w-5'/>
