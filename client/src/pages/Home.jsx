...
function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-[#010101] text-white overflow-hidden">
      <motion.div
      ...
      >
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-5">
            ...
            {/* object-cover ensures that img/content covers the entire container while maintaining aspect ratio and cropping if need be */}
          </div>
        </div>
      </motion.div>
          ...
          {highlights.map((h, i) => (
            ...
            >
              ...
              <p className="text-sm text-zinc-400">
                ...
                responsiveness and scalable structures.
              </p>
            </motion.div>
          ))}
        </div>
